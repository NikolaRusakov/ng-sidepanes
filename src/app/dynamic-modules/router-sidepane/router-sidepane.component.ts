...
@Component({
  selector: 'app-router-sidepane',
  templateUrl: './router-sidepane.component.html',
  styleUrls: ['./router-sidepane.scss'],
  providers: [],
  animations: [
    trigger('transition', [
...
export class RouterSidepaneComponent implements OnInit, AfterViewInit, OnDestroy, OnChanges {
  ...
  //
  // @Input()
  // cmpRef?: ComponentRef<RouterSidepaneComponent>;
  //
  ...
  constructor(
    ...
    private factoryService: SidepaneService,
